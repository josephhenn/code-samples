...
class RandomForest(object):
    ...
    def _bootstrapping(self, XX, n):
        ...
        for i in boot:
            samples.append(XX[i][0:40])
            labels.append(XX[i][41])
    ...
    def fitting(self):
        ...
        for i, j in zip(self.decision_trees, range(self.num_trees)):
            i.learn(self.bootstraps_datasets[j], self.bootstraps_labels[j])
